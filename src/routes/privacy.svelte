<div class="container">
	...
	<ul>
		...
		<li>
			<p>
				...
				or &quot;Our&quot; in this Agreement) refers to Zykkl's Portfolio.
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				<strong>Website</strong> refers to Zykkl's Portfolio, accessible from
				<a href="https://zykkl.dev" rel="external nofollow noopener" target="_blank"
					>https://zykkl.dev</a
				>
			</p>
		</li>
	...
	<p>
		...
		deleted as soon as You close Your web browser. Learn more about cookies on the <a
			...
			target="_blank">Privacy Policies website</a
		> article.
	</p>
	...
	<ul>
		<li>By email: hello@zykkl.dev</li>
	</ul>
</div>
